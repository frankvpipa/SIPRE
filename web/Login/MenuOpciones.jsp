    ...
    <ul>
        ...
        <li item-expanded='false' id="0" ><span item-title="true" style="font-weight: bold">TRAMITE DOCUMENTARIO</span>
            <ul style='width: 350px;'>
                ...
                <li item-expanded='false' name="tradi1" id="tradi/remision/remision.jsp">Remisión de Documentos</li>
                <li item-expanded='false' name="tradi2" id="NombreServlet/modo">Documentos Elevados</li>
                <li item-expanded='false' name="tradi3" id="NombreServlet/modo">Documentos Firmados</li>
            </ul>
        </li>
